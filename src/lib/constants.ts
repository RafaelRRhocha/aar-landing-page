...
export const EVENTS_DATA: Array<EventData> = [
  {
    id: 'baile',
    title: 'Baile de Luzes',
    description:
      'Evento beneficente tradicional com música e dança, promovendo integração e arrecadação de fundos.',
    folder: 'baile',
    featured: true,
  },
  {
  ...
  },
  {
    ...
    description:
      'Campanha anual de conscientização com ações de prevenção e exames gratuitos.',
  ...
  },
  {
    ...
    description:
      'Celebração de encerramento do ano com pacientes, familiares e voluntários.',
  ...
  },
  {
    ...
    description:
      'Campanha de incentivo à doação de órgãos realizada em 27 de setembro.',
    folder: 'doeorgaos',
  },
  {
...
export const RECOGNITIONS: Array<Recognition> = [
  {
    icon: Building2,
